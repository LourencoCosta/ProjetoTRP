...
<html>
    ...
    <body>
        ...
        <div id="show-pagamento" class="content scaffold-show" role="main">
            ...
            <f:display bean="pagamento" />
            <g:form resource="${this.pagamento}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.pagamento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
