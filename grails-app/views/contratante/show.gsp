...
<html>
    ...
    <body>
        ...
        <div id="show-contratante" class="content scaffold-show" role="main">
            ...
            <f:display bean="contratante" />
            <g:form resource="${this.contratante}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.contratante}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
