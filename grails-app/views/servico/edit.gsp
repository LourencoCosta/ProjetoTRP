...
<html>
    ...
    <body>
        ...
        <div id="edit-servico" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.servico}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.servico}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.servico}" method="PUT">
                <g:hiddenField name="version" value="${this.servico?.version}" />
                <fieldset class="form">
                    <f:all bean="servico"/>
                </fieldset>
