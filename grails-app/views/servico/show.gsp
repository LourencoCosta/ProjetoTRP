...
<html>
    ...
    <body>
        ...
        <div id="show-servico" class="content scaffold-show" role="main">
            ...
            <f:display bean="servico" />
            <g:form resource="${this.servico}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.servico}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
